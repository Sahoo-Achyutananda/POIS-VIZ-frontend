    ...
    <div className={cx('rounded-2xl border-2 p-4 space-y-3 flex-1', borderColor, bgColor)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-2xl">{isAlice ? '👩‍💻' : '👨‍💻'}</span>
      ...
      <div className="space-y-1">
        ...
        <div className="flex gap-2">
          ...
          />
          <Btn size="sm" variant="secondary" onClick={onRandomise}>🎲</Btn>
        </div>
      </div>
...
function EveMITMPanel({ mitm }) {
  if (!mitm) return null
  return (
    <Card title="🕵️ Eve — Man-in-the-Middle" accent className="border-rose-500/40">
      <div className="space-y-3">
        ...
        <div className="rounded-xl border border-rose-500/30 bg-rose-500/10 px-4 py-3 text-center space-y-1">
          <p className="text-rose-300 font-black text-sm">⚠ MITM Active — Alice &amp; Bob do NOT share a key!</p>
        ...
        <div className="space-y-1">
          ...
          {bits > 32 && (
            <p className="text-[11px] text-amber-400/70 italic">
              ⚠ Larger primes mean slower CDH brute force demo — stick to 16–32 for CDH tab.
            </p>
          )}
        </div>
            ...
            {tab === 'exchange' && (
              <div className="space-y-5">
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 px-2 py-4 min-w-[110px]">
                    ...
                    {exchange && (
                      <div className={cx(
                        ...
                        <p className={cx(
                          'font-mono text-[10px] font-black mt-0.5',
                          match ? 'text-purple-300' : 'text-rose-300'
                        )}>{match ? '✓ MATCH' : '✗ NO MATCH'}</p>
                      </div>
                    )}
                  </div>
                ...
                <div className="flex gap-3 items-center flex-wrap">
                  ...
                  {!params && <span className="text-xs text-amber-400">Load params first (⚙ tab)</span>}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-4 items-center flex-wrap">
                      <Btn
                        ...
                        id="pa11-mitm-btn"
                      >
                        {mitmLoading ? 'Attacking…' : '🕵️ Enable MITM Attack'}
                      </Btn>
                  ...
                  <>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                      <div className="flex-1 rounded-2xl border-2 border-blue-500/40 bg-blue-500/5 p-4 space-y-2">
                        <p className="text-blue-300 font-black text-lg">👩‍💻 Alice</p>
                      ...
                      <div className="flex-1 rounded-2xl border-2 border-emerald-500/40 bg-emerald-500/5 p-4 space-y-2">
                        <p className="text-emerald-300 font-black text-lg">👨‍💻 Bob</p>
              ...
              <div className="space-y-5">
                <Card title="How CDH Hardness Protects DH">
                  ...
                  <p className="text-xs text-amber-400/80 italic mt-2">
                    ⚠ Use the toy params (16–32 bit) or ⚙ tab to generate small params for a fast demo.
                    First run an Exchange in the 🔄 tab to get A and B values.
                  </p>
                </Card>
