          ...
          {accordionData.map((part, partIdx) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`inline-block shrink-0 text-base text-(--accent) transition-transform duration-200 ${openPart[partIdx] ? 'rotate-90' : ''}`}
                >
                  ›
                </span>
              </button>
                      ...
                      item.children && item.children.length > 0 ? (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={`inline-block shrink-0 text-sm text-(--accent) transition-transform duration-200 ${
